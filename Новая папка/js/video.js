...
button.addEventListener("click", () => { openTL.play(); $("body").addClass('lock'); $("#video").removeClass('diplay-none') })
backdrop.addEventListener("click", () => { openTL.reverse(); $("body").removeClass('lock'); $("#video").addClass('diplay-none'); video.pause(); })
